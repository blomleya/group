...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = 'blomleygroup090222_54ac35831d5dd1304117_20220209223610_archive.zip';
	const ARCHIVE_SIZE		 = '98318025';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = '54ac358-09223610';
    const SECONDARY_PACKAGE_HASH = '791462a-09223610';
	const VERSION			 = '1.4.3';
